...
class LargeCard : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.largecard)
        ...
        val tvBArr = arrayOf(
            ...
            R.id.tvB6, R.id.tvB7, R.id.tvB8, R.id.tvB9, R.id.tvB10, R.id.tvB11, R.id.tvB12,
            R.id.tvB13, R.id.tvB14, R.id.tvB15
        )
        val tvIArr = arrayOf(
            R.id.tvI1, R.id.tvI2, R.id.tvI3, R.id.tvI4, R.id.tvI5,
            R.id.tvI6, R.id.tvI7, R.id.tvI8, R.id.tvI9, R.id.tvI10, R.id.tvI11, R.id.tvI12,
            R.id.tvI13, R.id.tvI14, R.id.tvI15
        )
        val tvNArr = arrayOf(
            R.id.tvN1, R.id.tvN2, R.id.tvN3, R.id.tvN4, R.id.tvN5,
            R.id.tvN6, R.id.tvN7, R.id.tvN9, R.id.tvN10, R.id.tvN11, R.id.tvN12,
            R.id.tvN13, R.id.tvN14, R.id.tvN15
        )
        val tvGArr = arrayOf(
            R.id.tvG1, R.id.tvG2, R.id.tvG3, R.id.tvG4, R.id.tvG5,
            R.id.tvG6, R.id.tvG7, R.id.tvG8, R.id.tvG9, R.id.tvG10, R.id.tvG11, R.id.tvG12,
            R.id.tvG13, R.id.tvG14, R.id.tvG15
        )
        val tvOArr = arrayOf(
            R.id.tvO1, R.id.tvO2, R.id.tvO3, R.id.tvO4, R.id.tvO5,
            R.id.tvO6, R.id.tvO7, R.id.tvO8, R.id.tvO9, R.id.tvO10, R.id.tvO11, R.id.tvO12,
            R.id.tvO13, R.id.tvO14, R.id.tvO15
        )
